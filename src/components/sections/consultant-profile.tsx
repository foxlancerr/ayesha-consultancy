      ...
      <div className="mx-auto max-w-7xl px-4 md:px-6 lg:px-8">
        ...
        <div className="grid gap-16 md:grid-cols-2">
          <div className="flex items-center justify-center rounded-2xl border border-[#E2E8F0] bg-[#F8FAFC] p-16">
            <div className="h-40 w-40 rounded-full bg-[#E2E8F0]" />
          </div>
            ...
            <div className="space-y-5">
              {[
                ...
                <div key={i} className="flex items-start gap-3">
                  <div className="mt-1 flex h-5 w-5 shrink-0 items-center justify-center rounded-lg bg-[#15803D] text-xs text-white">✓</div>
                  <div>
