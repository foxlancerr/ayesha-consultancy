        ...
        <div className="grid gap-10 md:grid-cols-4">
          {howItSteps.map((step) => (
            <div key={step.step} className="flex flex-col items-center text-center">
              <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-[#0E2944] text-white shadow-sm">
                <span className="text-xl font-bold">{step.step}</span>
              </div>
              <h3 className="mb-3 text-lg font-semibold text-[#0E2944]">{step.title}</h3>
