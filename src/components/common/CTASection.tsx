      ...
      <div className="mx-auto max-w-7xl px-4 text-center md:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
          <a
            ...
            className="inline-flex items-center gap-2.5 rounded-xl bg-[#15803D] px-8 py-4 text-base font-semibold text-white transition-all duration-200 hover:bg-[#166534] shadow-sm"
          >
            {ctaLabel}
          </a>
          <a
