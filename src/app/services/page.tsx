        ...
        <section className="bg-[#0F172A] py-20 text-white">
          <div className="mx-auto max-w-7xl px-4 md:px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              <h1 className="mb-4 text-3xl font-bold tracking-tight sm:text-4xl">Our Services</h1>
              <p className="text-lg text-white/60">Professional tax services tailored to your needs.</p>
            </div>
          </div>
        </section>
