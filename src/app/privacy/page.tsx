    ...
    <>
      ...
      <main className="bg-white py-20">
        <div className="mx-auto max-w-3xl px-4 md:px-6 lg:px-8">
          <h1 className="mb-8 text-3xl font-bold text-[#0F172A]">Privacy Policy</h1>
          <div className="space-y-6">
            <p className="text-base text-[#334155]">Effective Date: [DATE]</p>
            ...
            <section>
              <h2 className="mb-3 text-lg font-bold text-[#0F172A]">1. Information We Collect</h2>
              <p className="text-base text-[#334155]">
            ...
            <section>
              <h2 className="mb-3 text-lg font-bold text-[#0F172A]">2. How We Use Your Information</h2>
              <p className="text-base text-[#334155]">
            ...
            <section>
              <h2 className="mb-3 text-lg font-bold text-[#0F172A]">3. Information Sharing</h2>
              <p className="text-base text-[#334155]">
            ...
            <section>
              <h2 className="mb-3 text-lg font-bold text-[#0F172A]">4. Data Security</h2>
              <p className="text-base text-[#334155]">
            ...
            <section>
              <h2 className="mb-3 text-lg font-bold text-[#0F172A]">5. Your Rights</h2>
              <p className="text-base text-[#334155]">
            ...
            <section>
              <h2 className="mb-3 text-lg font-bold text-[#0F172A]">6. Contact Us</h2>
              <p className="text-base text-[#334155]">
