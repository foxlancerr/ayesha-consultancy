    ...
    <>
      ...
      <main className="bg-white py-20">
        <div className="mx-auto max-w-3xl px-4 md:px-6 lg:px-8">
          <h1 className="mb-8 text-3xl font-bold text-[#0F172A]">Disclaimer</h1>
          <div className="space-y-6">
            ...
            <section>
              <h2 className="mb-3 text-lg font-bold text-[#0F172A]">1. General Disclaimer</h2>
              <p className="text-base text-[#334155]">
            ...
            <section>
              <h2 className="mb-3 text-lg font-bold text-[#0F172A]">2. Tax Advice</h2>
              <p className="text-base text-[#334155]">
            ...
            <section>
              <h2 className="mb-3 text-lg font-bold text-[#0F172A]">3. Liability Limitation</h2>
              <p className="text-base text-[#334155]">
            ...
            <section>
              <h2 className="mb-3 text-lg font-bold text-[#0F172A]">4. External Links</h2>
              <p className="text-base text-[#334155]">
            ...
            <section>
              <h2 className="mb-3 text-lg font-bold text-[#0F172A]">5. Changes to Disclaimer</h2>
              <p className="text-base text-[#334155]">
            ...
            <section>
              <h2 className="mb-3 text-lg font-bold text-[#0F172A]">6. Governing Law</h2>
              <p className="text-base text-[#334155]">
